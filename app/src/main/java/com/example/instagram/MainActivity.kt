...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<MaterialButton>(R.id.btn_post).setOnClickListener {
            // send post to server
            ...
            if (photoFile != null) {
                ...
                findViewById<ImageView>(R.id.iv_image).setImageResource(0);
                Toast.makeText(this, "Successfully Posted", Toast.LENGTH_SHORT).show()
            } else {
                Log.e(TAG, "error in sending message")
            }

        }

        findViewById<MaterialButton>(R.id.btn_takePicture).setOnClickListener {
    ...
    private fun submitPost(description: String, user: ParseUser, file: File) {
        ...
        post.saveInBackground { exception ->
            if (exception != null) {
                ...
                Toast.makeText(this, "Posting error occurred", Toast.LENGTH_SHORT).show()
            } else {
